import { Person, PersonCreate, Service } from './../../models/person';
...
@Component({
    ...
    imports: [ChartModule, RouterLink, HasPermissionDirective, DynamicDialogModule, TableModule, MenuModule, ButtonModule, InputTextModule, FormsModule, CommonModule, IconFieldModule, InputIconModule, TagModule, RippleModule, ToastModule],
    providers: [DialogService, MessageService],
    template: `
        <div class="grid grid-cols-12 gap-8">
            <div *hasPermission="'canCreate'" class="col-span-12 md:col-span-6 lg:col-span-3">
                <a
           ...
           dark:focus-visible:ring-offset-gray-900 group"
            ...
            <div class="col-span-12 md:col-span-4 xl:col-span-3">
                <p-toast />
                <p-button (click)="openCreateCommunityDialog()" styleClass="w-full bg-surface-0! dark:bg-surface-900! flex! flex-wrap! justify-start! h-24 border-surface! text-primary! p-4!">
                    <div
             ...
             <div class="col-span-12 md:col-span-4 xl:col-span-3">
                <p-button styleClass="w-full bg-surface-0! dark:bg-surface-900! flex! flex-wrap! justify-start! h-24 border-surface! text-primary! p-4!">
                    <div
                        class="w-12 h-12 p-4 flex justify-center items-center rounded-full bg-primary-50 text-primary mr-2 dark:bg-primary-900!"
                    >
...
export class Dashboard implements OnDestroy {
    ...
    ngOnInit() {
        ...
        /*         this.http.get(`${environment.apiBaseUrl}/Users/user-status`).subscribe(data => {
                    console.log(data);
                }); */
    ...
    openCreateCommunityDialog() {
        ...
        this.ref?.onClose.subscribe((data) => {
            ...
            if (data) {
                ...
                if(data.mode === 'create'){
                    ...
                    this.personService.createProfile(data.data).subscribe({
                        next: (response) => {
                            ...
                            summary_and_severity = { severity: 'success', summary: 'Utente Registrato', detail: data?.name };

                        },
                        error: (error) => {
                            console.error('Error creating profile', error);
                            summary_and_severity = { severity: 'error', summary: 'Registrazione annullata' };
                    ...
                    this.personService.updateProfile(data.data).subscribe({
                        next: () => {
                            ...
                            summary_and_severity = { severity: 'success', summary: 'Utente Aggiornato', detail: data.data.id };
                        },
                        error: (error) => {
                            console.error('Error updating profile', error);
                            summary_and_severity = { severity: 'error', summary: 'Aggiornamento annullato' };
                        }
                    });
                }
                ...
                summary_and_severity = { severity: 'warn', summary: 'Registrazione annullata' };
