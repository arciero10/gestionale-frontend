...
function zt(t2, e) {
  ...
  if (t2) {
    ...
    i2.left + a2 + d2 > l2.width - O() ? i2.left < d2 ? e % 2 === 1 ? c2 = i2.left ? "-" + i2.left + "px" : "100%" : e % 2 === 0 && (c2 = l2.width - d2 - O() + "px") : c2 = "-100%" : c2 = "100%", t2.getBoundingClientRect().top + u + s4 > l2.height ? f2 = `-${s4 - u}px` : f2 = "0px", t2.style.top = f2, t2.style.insetInlineStart = c2;
  }
}
function Zt(t2) {
  var e;
...
//# sourceMappingURL=chunk-MF57FWJL.js.map
